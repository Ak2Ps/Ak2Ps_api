...
exports.Retourverzendleverancier = void 0;
...
//
var dict = {
    table: "retourverzendleverancier",
    key: [],
    altKeys: [],
    foreignKeys: [],
    select: {
...
var Retourverzendleverancier = /** @class */ (function (_super) {
    __extends(Retourverzendleverancier, _super);
    function Retourverzendleverancier() {
        return _super.call(this, dict) || this;
    }
    Retourverzendleverancier.prototype.doQuery = function (req, res, next, options) {
            ...
            return __generator(this, function (_v) {
                switch (_v.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, retourtextfragmenten_1.Retourtextfragmenten.getRetourleverancier(req, res, next)];
                    case 2:
                        result = _v.sent();
                        //
                    ...
                    case 4:
                        ...
                        _f = res.crudData;
                        _g = _f.html;
                        return [4 /*yield*/, retourtextfragmenten_1.Retourtextfragmenten.getLeverancierHeader(req, res, next, '15em')];
                    case 5:
                        _f.html = _g + _v.sent();
                        _h = res.crudData;
                        _j = _h.html;
                        return [4 /*yield*/, retourtextfragmenten_1.Retourtextfragmenten.getMidTextLeverancier(req, res, next, '5em')];
                    case 6:
                        _h.html = _j + _v.sent();
                        _k = res.crudData;
                        _l = _k.html;
                        return [4 /*yield*/, retourtextfragmenten_1.Retourtextfragmenten.getItemsLeverancier(req, res, next, '20em')];
                    case 7:
                        _k.html = _l + _v.sent();
                        _m = res.crudData;
                        _o = _m.html;
                        return [4 /*yield*/, retourtextfragmenten_1.Retourtextfragmenten.getBottomTextLeverancier(req, res, next, '6em')];
                    case 8:
                        _m.html = _o + _v.sent();
                        _p = res.crudData;
                        _q = _p.html;
    ...
    Retourverzendleverancier.prototype.routes = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var method, action;
    ...
    return Retourverzendleverancier;
}(crud_1.Crud));
exports.Retourverzendleverancier = Retourverzendleverancier;
//# sourceMappingURL=retourverzendleverancier.js.map