...
var Soort = /** @class */ (function (_super) {
    __extends(Soort, _super);
    function Soort() {
        return _super.call(this, dict) || this;
    }
    Soort.prototype.doDelete = function (req, res, next, options) {
    ...
    Soort.prototype.doUpdate = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                util_1.Util.unknownOperation(req, res, next);
                return [2 /*return*/];
