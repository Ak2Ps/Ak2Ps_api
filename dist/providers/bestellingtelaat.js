...
exports.Bestellingtelaat = void 0;
...
var Bestellingtelaat = /** @class */ (function (_super) {
    __extends(Bestellingtelaat, _super);
    function Bestellingtelaat() {
        return _super.call(this, dict) || this;
    }
    Bestellingtelaat.prototype.doQuery = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, productgroep, productnummer, leveranciernummer, where, sql, rows;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        leveranciernummer = db_1.default.fix(req.query.leveranciernummer || '');
                        where = '';
    ...
    Bestellingtelaat.prototype.routes = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var method, action;
    ...
    return Bestellingtelaat;
}(crud_1.Crud));
exports.Bestellingtelaat = Bestellingtelaat;
//# sourceMappingURL=bestellingtelaat.js.map