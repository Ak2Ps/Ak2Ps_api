...
var Bewerkingfloweindcontrole = /** @class */ (function (_super) {
    __extends(Bewerkingfloweindcontrole, _super);
    function Bewerkingfloweindcontrole() {
        return _super.call(this, dict) || this;
    }
    Bewerkingfloweindcontrole.prototype.doQuery = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            var bewerkingsnummer, productnummer, thisECMDatum, thisUrl, thisDate, id, data, totAfkeur, totReparatie, result, rows, row, sql, sqlupdate, sqlbewerking, rowsbewerking, rowbewerking, sqlproduct, rowsproduct, rowproduct, sqlproductlijn, rowsproductlijn, rowproductlijn, sqltijd, rowstijd, rowtijd, irowtijd, sqluitval, rowsuitval, rowuitval, _a, irowuitval, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (!rowsbewerking[0]) return [3 /*break*/, 13];
                    ...
                    case 5:
                        data = _c.sent();
                        if (!(data == false)) return [3 /*break*/, 6];
                        rowbewerking.EINDCONTROLENUMMER = "Timeout Error on ECM";
                        return [3 /*break*/, 9];
                    case 6:
                        if (!(data.ErrorCode > 0)) return [3 /*break*/, 7];
                    ...
                    case 9:
                        ...
                        result += '<script>document.getElementById("b_barcode").innerHTML = draw39("B'
                            + config_1.Config.app + '-' + row.BEWERKINGSNUMMER
    ...
    Bewerkingfloweindcontrole.prototype.routes = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var method, action;
    ...
    return Bewerkingfloweindcontrole;
}(crud_1.Crud));
exports.Bewerkingfloweindcontrole = Bewerkingfloweindcontrole;
//# sourceMappingURL=bewerkingfloweindcontrole.js.map