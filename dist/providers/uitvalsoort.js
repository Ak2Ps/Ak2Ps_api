...
var Uitvalsoort = /** @class */ (function (_super) {
    ...
    Uitvalsoort.prototype.doDelete = function (req, res, next, options) {
    ...
    Uitvalsoort.prototype.doQuery = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                util_1.Util.unknownOperation(req, res, next);
                return [2 /*return*/];
    ...
    Uitvalsoort.prototype.doUpdate = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                util_1.Util.unknownOperation(req, res, next);
                return [2 /*return*/];
