            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db_1.default.waitDDL(res.crudConnection, sql)];
                    case 1:
                        rows = _a.sent();
                        if (rows[0]) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, db_1.default.waitDDL(res.crudConnection, sqldetail)];
                    case 3:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        rows = db_1.default.waitDDL(res.crudConnection, sql);
                        irow = 0;
                        _a.label = 2;
                    case 2:
                    ...
                    case 15:
                        ...
                        _a.label = 16;
                    case 16:
                        if (!(thisVersion == '2020.2')) return [3 /*break*/, 22];
