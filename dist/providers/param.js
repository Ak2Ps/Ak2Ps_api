...
var Param = /** @class */ (function (_super) {
    ...
    Param.prototype.getParam = function (req, res, next, options) {
    ...
    Param.prototype.setParam = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, rows, _a, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = res;
    ...
    Param.prototype.routes = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var method, action;
