...
var Productuitval = /** @class */ (function (_super) {
    __extends(Productuitval, _super);
    function Productuitval() {
        return _super.call(this, dict) || this;
    }
    Productuitval.prototype.doQuery = function (req, res, next, options) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    sql += "\ngroup by Lijn, Productnummer\norder by percuitval desc,lijn,productnummer\n) Somregel";
                                    //
                                    where = '';
                                    if (query.aantalvan != '') {
                                        where += util_1.Util.addAnd(where);
                                ...
                                case 3:
                                    ...
                                    util_1.Util.compareWithPhp(rows, req, res, next);
                                    resolve();
                                    return [2 /*return*/];
                            }
                        });
    ...
    Productuitval.prototype.routes = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var method, action;
            return __generator(this, function (_a) {
                method = req.method;
    ...
    return Productuitval;
}(crud_1.Crud));
exports.Productuitval = Productuitval;
//# sourceMappingURL=productuitval.js.map