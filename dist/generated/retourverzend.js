...
var Retourverzend = /** @class */ (function (_super) {
    ...
    Retourverzend.prototype.doSelect = function (req, res, next, options) {
    ...
    Retourverzend.prototype.doUpdate = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            var body, _a, id, sql;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    Retourverzend.prototype.doInsert = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Retourverzend.prototype.doDelete = function (req, res, next, options) {
        return __awaiter(this, void 0, void 0, function () {
            var body, _a, id, sql;
            return __generator(this, function (_b) {
                switch (_b.label) {
