...
export class Retourontvangst extends Crud {
    ...
    protected async doQuery(req: Request, res: Response, next: NextFunction, options?: Dict) {
        ...
        //
        let result = await Retourtextfragmenten.getRetour(req, res, next, "ontvangst");
        //
        ...
        res.crudData.html += await Retourtextfragmenten.getKlantHeader(req, res, next, '15em');
        res.crudData.html += await Retourtextfragmenten.getMidText(req, res, next, '8em');
        res.crudData.html += await Retourtextfragmenten.getItems(req, res, next, '18em');
        res.crudData.html += await Retourtextfragmenten.getBottomText(req, res, next, '6em');
